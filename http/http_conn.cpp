...
const char *doc_root = "/home/django/MyWork/TinyWebServer-master/root"/* "/home/qgy/github/TinyWebServer/root"*/;
...
bool http_conn::process_write(HTTP_CODE ret)
{
    ...
    {
        // 构造响应行 + 响应头 + 响应体
        add_status_line(200, "OK"); // 状态行：HTTP/1.1 200 OK
        add_headers(strlen("<h1>Hello from VMware!</h1>")); // 响应头
        add_content("<h1>Hello from VMware!</h1>"); // 响应体
        break;	
    }
...
void http_conn::process()
{
    ...
    // 新增日志：打印 process_write 的执行结果
    LOG_INFO("process_write result: %d", write_ret);
